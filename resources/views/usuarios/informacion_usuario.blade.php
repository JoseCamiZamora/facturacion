...
<div class="main-content-container container-fluid px-4">
              ...
              <div class="col-md-10 text-center text-sm-left mb-0">
               <span class="text-uppercase page-subtitle">Información y datos del Usuario</span>
                ...
                <div  class="col-md-2 text-right">
                  ...
                  @if(Auth::user()->rol==2)
                  <a href="{{ url('home') }}" class="mb-2 btn btn-sm  mr-1 btn-redondo-suave text-primary" title="salir a usuarios" ><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
                  @endif
                ...
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto" style="height: 150px; background-color:#f5f6f8;">
                      ...
                      <img src="{{ url('/mostrar_imagen/'.$usuario->id.'/'.$usuario->foto) }}" style='max-height: 150px;' onerror="this.src='{{
                        asset('assets/img/usuario.svg') }}'" id="logo_contratista" >
                               ...
                               <div class="form-group col-md-12">
                                ...
                                <select class="form-control" name="rol" >
                                  ...
                                  @elseif($usuario->rol==2)
                                     ...
                                     <option value="2"  selected >Recaudador</option>
 ...
 <label style="color:green;">Para cambiar sus datos , consulte al administrador del sistema</label>
