  ...
  <div class="page-header row no-gutters py-4">
    <div class="col">
      <span class="page-subtitle">Modulo Configuración </span>
        ...
        <h4 class="page-title" >Listado de Cargos de la Factura  <span style='font-size: 0.6em;'></span> </h4>
  ...
  <div class="row">
    <div class="col">
     ...
     <a  href="{{ url('configuracion/listado_valores') }}" class="mb-2 btn btn-sm btn-default mr-1 " ><i class="fas fa-file-invoice-dollar" aria-hidden="true" style="margin-right: 5px"></i>Valores Facturas</a>
      ...
      <a  href="{{ url('configuracion/listado_cargos') }}" class="mb-2 btn btn-sm btn-primary mr-1 " ><i class="fas fa-hand-holding-usd" style="margin-right: 5px"></i>Cargos</a>
           ...
           <thead class="bg-light">
              <tr>
                <th colspan="5" class="th-gris text-right"  >
                   <a href="javascript:void(0);" onclick="config_form_nuevo_cargo();" class="mb-2 btn btn-sm btn-primary mr-1" ><i class="far fa-plus-square" style="margin-right:10px;"></i>Nuevo cargo </a>
            ...
            <thead class="bg-light">
              ...
              <tr>
                ...
                <th scope="col" class="th-gris text-center " style="width: 150px;"  >-</th>
              ...
              @foreach($cargos as $car)
                ...
                <tr>
                  ...
                  <td class="td-btn-azul-claro" >
                    ...
                    <td>
                    <a class="nav-link nav-link-icon text-center" onclick="config_form_editar_cargo({{ $car->id }});" role="button" id="subirfile">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" id="datohtml">
        <h4 class="modal-title" id="titul_modal_cargos">Crear Nuevo Cargo</h4>
