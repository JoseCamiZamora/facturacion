...
<div class="main-content-container container-fluid px-4 pb-4">
 ...
 <form  method="post"  action="{{ url('cuentas/buscar_cuenta_congeladas') }}" id="f_buscar_cuenta"   >
        <input type="hidden" name="_token" id='_token_avatar' value="<?php echo csrf_token(); ?>">    
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              ...
              @if(isset($busqueda))
              <a href="{{ url('cuentas/listado_cuentas_congeladas') }}" class="btn btn-white  btn-azul"   >
            ...
            <thead class="bg-light">
              <tr>
               ...
               <th scope="col" class="th-gris text-center" style="width: 20px;" >No.</th>
                ...
                <th scope="col" class="th-gris text-left" style="width: 5px;">Apto</th>
                <th scope="col" class="th-gris text-left" style="width: 220px;">Dirección</th>
                <th scope="col" class="th-gris text-left " style="width: : 220px;">Propietario</th>
                <th scope="col" class="th-gris text-center" style="width: 1px;">Descongelar</th>
            ...
            <tbody>
             ...
             @foreach($cuentas as $cuenta)
                <tr>
                  ...
                  <td class='td-titulo text-center'  >{{ $cuenta->apto }}</td>
                  <td class='td-titulo text-center'  >{{ $cuenta->direccion }}</td>
                  <td class='text-left'  >{{ $cuenta->propietario }}</td>
                   <td>
                   <a class="nav-link nav-link-icon text-center"  role="button" id="subirfile" onclick="descongelarCuentas({{$cuenta->id}})" >
...
<div class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modal_descongelar_cuentas">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" id="datohtml">
        <h4 class="modal-title" id="titul_modal_usuarios">Descongelar Cuenta</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body" id="contenido_modal_cuentas_d" style='min-height: 400px;'>
      </div>
    </div>
  </div>
</div>
